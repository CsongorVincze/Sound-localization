...
# ==========================================
true_angle = 67 * deg # The actual direction the sound is coming from
...
# Refractory period set to 130ns to mimic the observed reset plateau
mott_neurons = NeuronGroup(num_neurons, mott_eqs, 
                           threshold='v > v_thresh', 
                           reset='v = v_reset', 
                           refractory=130*nsecond, 
                           method='exact')
...
if len(spike_mon.i) > 0:
    print(f"Mott Neuron tuned to {target_angles[spike_mon.i[0]]/deg}° successfully fired!")
else:
